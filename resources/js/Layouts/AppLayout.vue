<template>
    <div class="min-h-screen bg-gray-100" style="background: linear-gradient(#D4EDDA,10%, white)">
        <nav class="bg-white border-b border-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <a href="/">
                                <img alt="logo TeachMe" src="../../../public/img/logo-site.png"
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <jet-nav-link href="/courses" class="text-decoration-none" style="color:#1062AB"
                                          :active="$page.currentRouteName === 'courses'">
                                Cours
                            </jet-nav-link>

                            <jet-nav-link href="/credits" class="text-decoration-none" style="color:#F21D2F"
                                          :active="$page.currentRouteName === 'credits'">
                                Informations
                            </jet-nav-link>

                            <jet-nav-link href="/contact" class="text-decoration-none" style="color:#18AB4A"
                        ...
                        <div class="ml-3 relative">
                            <jet-dropdown align="right" width="48">
                                ...
                                <template #content>
                                    ...
                                    <jet-dropdown-link class="text-decoration-none" href="/user/profile">
                                        Profil
                                    </jet-dropdown-link>

                                    <jet-dropdown-link class="text-decoration-none" href="/user/api-tokens"
                                    ...
                                    <form @submit.prevent="logout">
                                        <jet-dropdown-link class="text-decoration-none" as="button">
                                            Déconnexion
                                        </jet-dropdown-link>
                                    </form>
                                </template>
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                <div class="navbar-nav ml-auto ">
                    <jet-nav-link href="/" class="text-decoration-none" style="color:#F58F19"
        ...
        <header class="bg-white shadow text-center" >
            <div class="mx-auto py-9 px-4 sm:px-6 lg:px-8">
